  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.center}>
        <div>
          <Image className={styles.logo} src="/next.svg" alt="Next.js Logo" width={480} height={37} priority />
          <Image classname={styles.logo} src="/next.svg" alt="Next.js Logo" width={180} height={27} priority />
        </div>
      </div>
